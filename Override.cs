...
public class Jogo : Produto {
    ...
    public override void Promocao(){
      Console.WriteLine("promoção jogo naruto shippuden PREMIUM")
    }
}
...
Jogo jogo = new Jogo("Marvel'naruto shippuden PREMIUM", 299.9,"Jogo completo Naruto shippuden ultimate para PS5." , "Jogo PS5", "Ação e Aventura");
    jogo.Promocao();

    Acessorio acessorio = new Acessorio("Suporte para Controle de Vídeo Game", 50, "Suporte para colocar o Controle em cima", "Suporte");
    acessorio.Promocao();

    Colecionavel colecionavel = new Colecionavel("Coleção de Jogos naruto shippuden ultimate", 5.127,63, "naruto shippuden ultimate", "Todos os Jogos");
